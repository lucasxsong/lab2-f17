...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 7f 77 10 80 	movl   $0x8010777f,(%esp)
...
80100b5e:	e8 dd 5c 00 00       	call   80106840 <allocuvm>
...
80100c01:	e8 5a 5d 00 00       	call   80106960 <freevm>
  return -1;
...
80100cfc:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80100d03:	00 
80100d04:	c7 04 24 70 6e 10 80 	movl   $0x80106e70,(%esp)
80100d0b:	e8 40 f9 ff ff       	call   80100650 <cprintf>
 switchuvm(curproc);
80100d10:	89 3c 24             	mov    %edi,(%esp)
80100d13:	e8 c8 58 00 00       	call   801065e0 <switchuvm>
  freevm(oldpgdir);
80100d18:	89 34 24             	mov    %esi,(%esp)
80100d1b:	e8 40 5c 00 00       	call   80106960 <freevm>
  return 0;
...
80100d46:	c7 44 24 04 9c 6e 10 	movl   $0x80106e9c,0x4(%esp)
80100d4d:	80 
...
80100e06:	c3                   	ret    
    panic("filedup");
80100e07:	c7 04 24 a3 6e 10 80 	movl   $0x80106ea3,(%esp)
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100ecc:	c7 04 24 ab 6e 10 80 	movl   $0x80106eab,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  panic("fileread");
80100fb7:	c7 04 24 b5 6e 10 80 	movl   $0x80106eb5,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010d1:	c7 04 24 be 6e 10 80 	movl   $0x80106ebe,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010dd:	c7 04 24 c4 6e 10 80 	movl   $0x80106ec4,(%esp)
...
80101195:	c7 04 24 ce 6e 10 80 	movl   $0x80106ece,(%esp)
...
801012bd:	c7 04 24 e4 6e 10 80 	movl   $0x80106ee4,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  panic("bmap: out of range");
80101377:	c7 04 24 f4 6e 10 80 	movl   $0x80106ef4,(%esp)
...
80101459:	c7 04 24 07 6f 10 80 	movl   $0x80106f07,(%esp)
...
8010147c:	c7 44 24 04 1a 6f 10 	movl   $0x80106f1a,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 21 6f 10 	movl   $0x80106f21,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 84 6f 10 80 	movl   $0x80106f84,(%esp)
...
801015e1:	c7 04 24 27 6f 10 80 	movl   $0x80106f27,(%esp)
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 3f 6f 10 80 	movl   $0x80106f3f,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 39 6f 10 80 	movl   $0x80106f39,(%esp)
...
801017be:	e9 1d 28 00 00       	jmp    80103fe0 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 4e 6f 10 80 	movl   $0x80106f4e,(%esp)
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 68 6f 10 80 	movl   $0x80106f68,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 56 6f 10 80 	movl   $0x80106f56,(%esp)
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 77 6f 10 80 	movl   $0x80106f77,(%esp)
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 66 75 10 80 	movl   $0x80107566,(%esp)
...
80101fdf:	c7 04 24 e0 6f 10 80 	movl   $0x80106fe0,(%esp)
80101fe6:	e8 75 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101feb:	c7 04 24 d7 6f 10 80 	movl   $0x80106fd7,(%esp)
...
80102006:	c7 44 24 04 f2 6f 10 	movl   $0x80106ff2,0x4(%esp)
8010200d:	80 
...
801021d9:	eb bb                	jmp    80102196 <iderw+0x76>
    panic("iderw: buf not locked");
801021db:	c7 04 24 f6 6f 10 80 	movl   $0x80106ff6,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 21 70 10 80 	movl   $0x80107021,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021f3:	c7 04 24 0c 70 10 80 	movl   $0x8010700c,(%esp)
...
80102248:	c7 04 24 40 70 10 80 	movl   $0x80107040,(%esp)
...
8010237c:	eb bb                	jmp    80102339 <kfree+0x49>
    panic("kfree");
8010237e:	c7 04 24 72 70 10 80 	movl   $0x80107072,(%esp)
...
801023eb:	c7 44 24 04 78 70 10 	movl   $0x80107078,0x4(%esp)
801023f2:	80 
...
80103666:	c7 04 24 38 74 10 80 	movl   $0x80107438,(%esp)
...
80103817:	e8 c4 2d 00 00       	call   801065e0 <switchuvm>
  return 0;
...
8010387e:	e8 3d 32 00 00       	call   80106ac0 <copyuvm>
...
80103a6e:	c7 04 24 90 73 10 80 	movl   $0x80107390,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 ae 73 10 80 	movl   $0x801073ae,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 a2 73 10 80 	movl   $0x801073a2,(%esp)
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 dd 73 10 80 	movl   $0x801073dd,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 d0 73 10 80 	movl   $0x801073d0,(%esp)
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 7f 77 10 80 	movl   $0x8010777f,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ead:	ba 00 74 10 80       	mov    $0x80107400,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103eb2:	77 11                	ja     80103ec5 <procdump+0x55>
80103eb4:	8b 14 85 60 74 10 80 	mov    -0x7fef8ba0(,%eax,4),%edx
      state = "???";
80103ebb:	b8 00 74 10 80       	mov    $0x80107400,%eax
...
80103ed0:	c7 04 24 04 74 10 80 	movl   $0x80107404,(%esp)
...
80103f4a:	c7 44 24 04 78 74 10 	movl   $0x80107478,0x4(%esp)
80103f51:	80 
...
801041a7:	eb ac                	jmp    80104155 <acquire+0x15>
    panic("acquire");
801041a9:	c7 04 24 83 74 10 80 	movl   $0x80107483,(%esp)
...
80104209:	c3                   	ret    
    panic("popcli");
8010420a:	c7 04 24 a2 74 10 80 	movl   $0x801074a2,(%esp)
80104211:	e8 4a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104216:	c7 04 24 8b 74 10 80 	movl   $0x8010748b,(%esp)
...
8010423f:	75 0f                	jne    80104250 <release+0x20>
    panic("release");
80104241:	c7 04 24 a9 74 10 80 	movl   $0x801074a9,(%esp)
...
8010465d:	8b 14 85 e0 74 10 80 	mov    -0x7fef8b20(,%eax,4),%edx
...
80104686:	c7 04 24 b1 74 10 80 	movl   $0x801074b1,(%esp)
...
80104810:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104817:	80 
...
8010482b:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104832:	80 
...
80104841:	79 89                	jns    801047cc <create+0xdc>
      panic("create dots");
80104843:	c7 04 24 4f 75 10 80 	movl   $0x8010754f,(%esp)
8010484a:	e8 11 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010484f:	c7 04 24 5e 75 10 80 	movl   $0x8010755e,(%esp)
80104856:	e8 05 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010485b:	c7 04 24 40 75 10 80 	movl   $0x80107540,(%esp)
...
80104c01:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104c08:	80 
...
80104c19:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104c20:	80 
...
80104d6d:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
80104d74:	e8 e7 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d79:	c7 04 24 92 75 10 80 	movl   $0x80107592,(%esp)
80104d80:	e8 db b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d85:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
...
80105239:	e8 82 1b 00 00       	call   80106dc0 <shm_open>
}
8010523e:	c9                   	leave  
8010523f:	c3                   	ret    
    return -1;
...
80105273:	e8 58 1b 00 00       	call   80106dd0 <shm_close>
}
80105278:	c9                   	leave  
80105279:	c3                   	ret    
...
8010533b:	e8 a0 e4 ff ff       	call   801037e0 <growproc>
...
801054b9:	c7 44 24 04 a1 75 10 	movl   $0x801075a1,0x4(%esp)
801054c0:	80 
...
80105550:	ff 24 85 48 76 10 80 	jmp    *-0x7fef89b8(,%eax,4)
80105557:	90                   	nop
    lapiceoi();
    break;
...
801055c3:	c7 04 24 04 76 10 80 	movl   $0x80107604,(%esp)
...
8010577a:	c7 04 24 d0 75 10 80 	movl   $0x801075d0,(%esp)
80105781:	89 44 24 04          	mov    %eax,0x4(%esp)
80105785:	e8 c6 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010578a:	c7 04 24 a6 75 10 80 	movl   $0x801075a6,(%esp)
...
80105887:	00 
  for(p="xv6...\n"; *p; p++)
80105888:	bb c8 76 10 80       	mov    $0x801076c8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010646a:	c3                   	ret    
        panic("kfree");
8010646b:	c7 04 24 72 70 10 80 	movl   $0x80107072,(%esp)
...
801065b1:	c3                   	ret    
      panic("remap");
801065b2:	c7 04 24 d0 76 10 80 	movl   $0x801076d0,(%esp)
...
801066c1:	c7 04 24 d6 76 10 80 	movl   $0x801076d6,(%esp)
801066c8:	e8 93 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066cd:	c7 04 24 01 77 10 80 	movl   $0x80107701,(%esp)
801066d4:	e8 87 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066d9:	c7 04 24 ec 76 10 80 	movl   $0x801076ec,(%esp)
...
8010676e:	c7 04 24 15 77 10 80 	movl   $0x80107715,(%esp)
...
80106822:	c7 04 24 2f 77 10 80 	movl   $0x8010772f,(%esp)
80106829:	e8 32 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010682e:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
...
801068d2:	c7 04 24 4d 77 10 80 	movl   $0x8010774d,(%esp)
...
80106900:	c7 04 24 65 77 10 80 	movl   $0x80107765,(%esp)
...
801069c3:	e9 28 b9 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
801069c8:	c7 04 24 81 77 10 80 	movl   $0x80107781,(%esp)
...
80106aab:	c3                   	ret    
    panic("clearpteu");
80106aac:	c7 04 24 92 77 10 80 	movl   $0x80107792,(%esp)
...
80106ad3:	0f 84 96 01 00 00    	je     80106c6f <copyuvm+0x1af>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106ad9:	8b 45 0c             	mov    0xc(%ebp),%eax
80106adc:	85 c0                	test   %eax,%eax
80106ade:	0f 84 ac 00 00 00    	je     80106b90 <copyuvm+0xd0>
...
80106b2c:	78 4d                	js     80106b7b <copyuvm+0xbb>
  for(i = 0; i < sz; i += PGSIZE){
80106b2e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b34:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106b37:	76 57                	jbe    80106b90 <copyuvm+0xd0>
...
80106b47:	0f 84 35 01 00 00    	je     80106c82 <copyuvm+0x1c2>
    if(!(*pte & PTE_P))
80106b4d:	8b 30                	mov    (%eax),%esi
80106b4f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b55:	0f 84 1b 01 00 00    	je     80106c76 <copyuvm+0x1b6>
    pa = PTE_ADDR(*pte);
80106b5b:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106b5d:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106b63:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106b66:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106b6c:	e8 2f b9 ff ff       	call   801024a0 <kalloc>
80106b71:	85 c0                	test   %eax,%eax
80106b73:	89 c6                	mov    %eax,%esi
80106b75:	0f 85 6d ff ff ff    	jne    80106ae8 <copyuvm+0x28>
  }
...
80106b81:	e8 da fd ff ff       	call   80106960 <freevm>
  return 0;
80106b86:	31 c0                	xor    %eax,%eax
}
80106b88:	83 c4 2c             	add    $0x2c,%esp
80106b8b:	5b                   	pop    %ebx
80106b8c:	5e                   	pop    %esi
80106b8d:	5f                   	pop    %edi
80106b8e:	5d                   	pop    %ebp
...
80106b90:	e8 0b cb ff ff       	call   801036a0 <myproc>
80106b95:	c7 45 dc ff ff ff 7f 	movl   $0x7fffffff,-0x24(%ebp)
80106b9c:	8b 40 7c             	mov    0x7c(%eax),%eax
80106b9f:	c1 e0 0c             	shl    $0xc,%eax
80106ba2:	29 45 dc             	sub    %eax,-0x24(%ebp)
  for(i = STACKBASE; i > stackTop; i -= PGSIZE) {
80106ba5:	81 7d dc fe ff ff 7f 	cmpl   $0x7ffffffe,-0x24(%ebp)
80106bac:	0f 87 a5 00 00 00    	ja     80106c57 <copyuvm+0x197>
80106bb2:	bb ff ff ff 7f       	mov    $0x7fffffff,%ebx
80106bb7:	eb 5f                	jmp    80106c18 <copyuvm+0x158>
80106bb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106bc0:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106bc6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106bcd:	00 
80106bce:	89 74 24 04          	mov    %esi,0x4(%esp)
...
80106bdd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106be4:	00 
80106be5:	89 44 24 10          	mov    %eax,0x10(%esp)
80106be9:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106bef:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106bf3:	89 d8                	mov    %ebx,%eax
80106bf5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106bfa:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bfe:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c01:	89 04 24             	mov    %eax,(%esp)
80106c04:	e8 37 f9 ff ff       	call   80106540 <mappages>
80106c09:	85 c0                	test   %eax,%eax
80106c0b:	78 55                	js     80106c62 <copyuvm+0x1a2>
  for(i = STACKBASE; i > stackTop; i -= PGSIZE) {
80106c0d:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c13:	39 5d dc             	cmp    %ebx,-0x24(%ebp)
80106c16:	73 3f                	jae    80106c57 <copyuvm+0x197>
    if((pte = walkpgdir(pgdir, (void*) i, 0)) == 0)
80106c18:	8b 45 08             	mov    0x8(%ebp),%eax
80106c1b:	31 c9                	xor    %ecx,%ecx
80106c1d:	89 da                	mov    %ebx,%edx
80106c1f:	e8 2c f7 ff ff       	call   80106350 <walkpgdir>
80106c24:	85 c0                	test   %eax,%eax
80106c26:	74 5a                	je     80106c82 <copyuvm+0x1c2>
    if(!(*pte & PTE_P))
80106c28:	8b 38                	mov    (%eax),%edi
80106c2a:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106c30:	74 44                	je     80106c76 <copyuvm+0x1b6>
    pa = PTE_ADDR(*pte);
80106c32:	89 fe                	mov    %edi,%esi
    flags = PTE_FLAGS(*pte);
80106c34:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106c3a:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c3d:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106c43:	e8 58 b8 ff ff       	call   801024a0 <kalloc>
80106c48:	85 c0                	test   %eax,%eax
80106c4a:	89 c7                	mov    %eax,%edi
80106c4c:	0f 85 6e ff ff ff    	jne    80106bc0 <copyuvm+0x100>
80106c52:	e9 24 ff ff ff       	jmp    80106b7b <copyuvm+0xbb>
80106c57:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106c5a:	83 c4 2c             	add    $0x2c,%esp
80106c5d:	5b                   	pop    %ebx
80106c5e:	5e                   	pop    %esi
80106c5f:	5f                   	pop    %edi
80106c60:	5d                   	pop    %ebp
80106c61:	c3                   	ret    
      kfree(mem);
80106c62:	89 3c 24             	mov    %edi,(%esp)
80106c65:	e8 86 b6 ff ff       	call   801022f0 <kfree>
      goto bad;
80106c6a:	e9 0c ff ff ff       	jmp    80106b7b <copyuvm+0xbb>
    return 0;
80106c6f:	31 c0                	xor    %eax,%eax
80106c71:	e9 12 ff ff ff       	jmp    80106b88 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106c76:	c7 04 24 b6 77 10 80 	movl   $0x801077b6,(%esp)
80106c7d:	e8 de 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c82:	c7 04 24 9c 77 10 80 	movl   $0x8010779c,(%esp)
...
80106c9e:	e8 ad f6 ff ff       	call   80106350 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d66:	c7 44 24 04 f4 77 10 	movl   $0x801077f4,0x4(%esp)
80106d6d:	80 
